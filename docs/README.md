...
<img src="~@assets/intro/framework.gif" height="260" />
...
中层是一系列**D2C2D**（设计资产与组件双向转换）、**C2R**（组件到发布）过程的解决方案和基础服务。
...
在设计与代码智能转换或设计资产管理的方向，业界存在诸多的D2C、Less/Node Code解决方案。而本方案侧重支持**持续集成**、**分布上线**的应用架构，因此与他们有不同的目标，包括不限于以下：
