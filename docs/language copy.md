...
图层是设计稿中最基本的构成单位，在这个手册中，我们所说的“图层”和“对象”其实是一样的意思，这两个词是可以相互替换的。

图层处在坐标系统中，具有位置属性。无位置属性的元素必不是图层。
...
组件，又称符号（Symbol）或控件，可以帮助设计师快速重用一些设计元素。
...
属性映射是在设计、交付过程中自然建立的，融入在工作流中，设计师无需额外投入成本。
